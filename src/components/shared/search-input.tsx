 ...
 */
export function SearchInput({ className, placeholder = 'Search...', value, onValueChange, debounceMs = DEFAULT_DEBOUNCE_MS, ...props }: SearchInputProps) {
    ...
    return (
        <div className={cn('relative w-full', className)}>
            ...
            <Input
                ...
                className="px-9 pr-8 bg-transparent border-border"
                {...props}
            />
            {localValue && (
                <button
